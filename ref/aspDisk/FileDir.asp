...
sql="select * from Vip_Photo where FileDir_id in(select FileDir_id from Vip_FileDir where FileDir_Name='"&FileDir_Namelist&"' and FileDir_Userid="&User_id&") order by id desc"
